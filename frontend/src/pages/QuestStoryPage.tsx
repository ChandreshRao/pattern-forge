...
import { cueForBeat } from '@/content/npcs'
...
export function QuestStoryPage() {
  ...
  const cue = cueForBeat(quest.beat_id)
      ...
      <motion.div initial={{ opacity: 0, y: 12 }} animate={{ opacity: 1, y: 0 }} className="mt-6">
        ...
        <div className="mt-6">
          <NpcDialoguePanel
            ...
            lines={[
              { text: quest.story.hook },
              { label: 'Briefing', text: quest.story.briefing },
              { label: 'Objective', text: quest.story.objective_in_world },
            ]}
          />
        </div>

        <section className="mt-8 rounded-md border border-[rgba(232,220,200,0.12)] bg-[rgba(15,23,36,0.45)] p-6">
